...
// ############################ S E T U P ##########################################
		...
		*/
		...
		"Smiter": { // Farmer profile name
			// Put key finder profiles here. Example - KeyFinderProfiles: ["MF 1", "MF 2"],
			KeyFinderProfiles: ["laz1", "cyquaia-018", "cyquaia-019", "cyquaia-020", "cyquaia-021", "cyquaia-022", "cyquaia-023", "cyquaia-024", "cyquaia-026", "cyquaia-027", "cyquaia-028", "cyquaia-029", "cyquaia-030", "cyquaia-031", "cyquaia-032", "cyquaia-033", "cyquaia-035", "cyquaia-036", "cyquaia-037", "cyquaia-038", "cyquaia-039", "cyquaia-040", "cyquaia-042", "cyquab002", "cyquab003", "cyquab004", "cyquab005", "cyquab009", "cyquab010", "cyquab011", "cyquab012"],
	...
	inGameCheck: function () {
		...
		for (i = 0; i < farmers.length; i += 1) {
			if (farmers[i].FarmGame.length > 0 && me.gamename.toLowerCase().match(farmers[i].FarmGame.toLowerCase())) {
				...
				if (me.getStat (15) >= 50000) { //Get gold from stash
					gold(50000, 4); //Withdraw from stash
					gold(50000); //Drop gold
				}
